...
class ChecklistPreventivaService {
  ...
  static Future<String?> enviarChecklist(ChecklistPreventiva checklist) async {
    final payload = {
      ...
      'chkDesmontagem'              : _chk(checklist.chkDesmontagem, checklist.obsDesmontagem),
      'chkLavagemQuimica'           : _chk(checklist.chkLavagemQuimica, checklist.obsLavagemQuimica),
      ...
      'chkRuidoVibracao'            : _chk(checklist.chkRuidoVibracao, checklist.obsRuidoVibracao, problemaQuandoSim: true),
      ...
      'chkSubstituicaoIsolamento'   : checklist.chkSubstituicaoIsolamento,
      'metrosIsolamentoTrocados'    : checklist.metrosIsolamentoTrocados ?? '',
      ...
      'linkFotoProcesso'            : checklist.linkFotoProcesso ?? '',
      'linkFotoFinal'               : checklist.linkFotoFinal ?? '',
      'observacoesTecnicas'         : checklist.observacoesTecnicas ?? '',
